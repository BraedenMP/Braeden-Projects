...
$pageTitle = "Just Wired Handmade Beaded Jewelry - Others"; 
...
$pageCanonical = "http://justwired.com/others/";
include("include/head.php");
?>

<body>
    <div class="fullPage animsition">
    <header id="othersHead" class="jumbotron">
    <?php include("include/mobileNav.php"); ?>
      <div class="sticky navBar normNav">
        ...
        <ul>
          ...
          <li><a href="others.php" class="animsition-link selected"><span>Other</span></a></li>
      ...
      <div class="headings paraHead">
        <h1 class="page-header fontfx">Others</h1>
...
<!-- similar to shirt.php but the foreach makes it gather all products-->
          <?php foreach($others as $product_id => $product) { 
              echo get_list_view_html_others($product_id,$product);
            }
          ?>
        </ul>
      </div>
