...
$pageTitle = "Just Wired Handmade Beaded Jewelry - Necklaces"; 
...
$pageCanonical = "http://justwired.com/necklaces/";
include("include/head.php");
?>

<body>
    <div class="fullPage animsition">
    <header id="necklacesHead" class="jumbotron">
    <?php include("include/mobileNav.php"); ?>
      <div class="sticky navBar normNav">
       <nav class="nav nav-pills top-bar row" data-topbar role="navigation" data-options="sticky_on: small, medium, large">
        ...
        <ul>
          <li><a href="necklaces.php" class="animsition-link selected"><span>Necklaces</span></a></li>
      ...
      <div class="headings paraHead">
        <h1 class="page-header fontfx">Necklaces</h1>
...
<!-- similar to shirt.php but the foreach makes it gather all products-->
          <?php foreach($necklaces as $product_id => $product) { 
              echo get_list_view_html_necklaces($product_id,$product);
            }
          ?>
        </ul>
      </div>
